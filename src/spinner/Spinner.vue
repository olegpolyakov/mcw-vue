...
export default {
    ...
    computed: {
        classes() {
            return {
                'mdc-spinner--colorful': this.colorful
            };
        }
    }
}
...
<template>
    <svg class="mdc-spinner" :class="classes" viewBox="0 0 66 66" xmlns="http://www.w3.org/2000/svg" v-bind="$attrs" v-on="$listeners">
        <circle class="mdc-spinner__circle" cx="33" cy="33" r="30" />
    </svg>
</template>
